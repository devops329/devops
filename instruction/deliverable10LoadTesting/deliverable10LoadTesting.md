...
```masteryls
{"id":"69839e67-9763-4434-a6d8-4e0713380a08", "title":"⓾ Load testing deliverable", "type":"url-submission", "syncGrade":true, "autoGrade":false, "validateUrl":true, "gradingCriteria":"- The resulting file contains JavaScript that executes a K6 load test.", "urlPrompt":"Convert the user provided URL to create a URL that is the path to the raw GitHub content for the 'loadTests/loginAndOrder.js' file." }
