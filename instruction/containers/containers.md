...
| docker ps -a                                                        | List all of the containers, running or otherwise. Use this to get the container IDs. |
...
| docker exec <container ID> ls -la                                   | Run a console command in the container.                                              |
|                                                                     |                                                                                      |
