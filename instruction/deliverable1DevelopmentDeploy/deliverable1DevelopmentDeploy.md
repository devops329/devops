...
```masteryls
{"id":"4261e0b4-655b-4740-9f3b-52f50d1fa29f", "title":"⓵ Development deployment submission", "type":"url-submission", "syncGrade":true, "autoGrade":false, "validateUrl":true, "gradingCriteria":"- Include a section named `JWT Pizza code study and debugging` that contains a table of possible user activities. This table must be completely filled up", "urlPrompt":"Convert the user provided URL to create a URL that is the path to the raw GitHub content for the notes.md file." }
