...
obj.defaultHotkeys = {
   ...
   -- bottom_left  = { {"ctrl",        "cmd"}, "3" },
   -- bottom_right = { {"ctrl",        "cmd"}, "4" },
   one_top_left = { {"ctrl",        "cmd"}, "1" },
   two_top_center = { {"ctrl",        "cmd"}, "2" },
   three_top_right = { {"ctrl",        "cmd"}, "3" },
   four_center_left = { {"ctrl",        "cmd"}, "4" },
   five_center_center = { {"ctrl",        "cmd"}, "5" },
   six_center_right = { {"ctrl",        "cmd"}, "6" },
   seven_bottom_left = { {"ctrl",        "cmd"}, "7" },
   eight_bottom_center = { {"ctrl",        "cmd"}, "8" },
   nine_bottom_right = { {"ctrl",        "cmd"}, "9" },
   max_toggle   = { {"ctrl", "alt", "cmd"}, "f" },
   max          = { {"ctrl", "alt", "cmd"}, "Up" },
   undo         = { {        "alt", "cmd"}, "z" },
   center       = { {        "alt", "cmd"}, "c" },
...
obj._window_state_name_to_rect = {
   left_half      = {0.00,0.20,0.50,0.80}, -- two decimal places required for `window_state_rect_strings` to match
   left_25        = {0.00,0.20,0.25,0.80},
   left_40        = {0.00,0.20,0.40,0.80},
   left_60        = {0.00,0.20,0.60,0.80},
   right_half     = {0.50,0.20,0.50,0.80},
   right_25       = {0.75,0.20,0.25,0.80},
   right_40       = {0.60,0.20,0.40,0.80},
   right_60       = {0.40,0.20,0.60,0.80},
   top_half       = {0.00,0.20,1.00,0.50},
   top_40         = {0.00,0.20,1.00,0.40},
   top_60         = {0.00,0.20,1.00,0.60},
   ...
   one_top_left   = {0.00,0.00,0.25,0.20},
   two_top_center   = {0.25,0.00,0.50,0.20},
   three_top_right   = {0.75,0.00,0.25,0.20},
   four_center_left   = {0.00,0.20,0.25,0.40},
   five_center_center   = {0.25,0.20,0.50,0.80},
   six_center_right   = {0.75,0.20,0.25,0.40},
   seven_bottom_left   = {0.00,0.60,0.25,0.40},
   eight_bottom_center   = {0.25,0.60,0.50,0.40},
   nine_bottom_right   = {0.75,0.60,0.25,0.40},
   max            = {0.00,0.20,1.00,0.80},
}
...
--   (example below)
obj._window_moves = {
   left_half = {"left_half", left_half = "left_25", left_25 = "left_40", left_40 = "left_60"},
   half_left = {"left_half"},
   ...
   right_half = {"right_half", right_half = "right_25", right_25 = "right_40", right_40 = "right_60"},
   ...
   one_top_left = {"one_top_left"},
   two_top_center = {"two_top_center"},
   three_top_right = {"three_top_right"},
   four_center_left = {"four_center_left"},
   five_center_center = {"five_center_center"},
   six_center_right = {"six_center_right"},
   seven_bottom_left = {"seven_bottom_left"},
   eight_bottom_center = {"eight_bottom_center"},
   nine_bottom_right = {"nine_bottom_right"},
   max = {"max"},
}
