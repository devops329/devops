...
When your customers have the perspective that your application is unstable or that your company doesn't care about stability, they will quickly find an alternative in your competitor's offering. As software engineer who cares quality, you can approach this from several different angles:
...
1. **Ensure quality**: Invest significantly is testing.
...
Notice that they specify what the when the problem was discovered, what the problem is, and what the current state is. You can even subscribe to receive updates.

#### status.grafana.com

Grafana takes things a step further. If there is a serious problem with functionality that they detect you are using, then will display a message banner directly on impacted page.
