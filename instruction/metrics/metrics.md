...
This still leaves the question: Why did latency jump from 10 ms to 18 ms around 9:50?. Now I'm starting to feel like a detective hot on the trail of a crime. If we drill in to a five-minute window we notice that the active users metric has an annotation that an alert was triggered around this time.
